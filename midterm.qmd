...
The four missing zip codes correspond to the four missing coordinates. So, 
there is no way to recover the zip codes. Since our model will rely on zip code 
specific information, we will drop these rows.
